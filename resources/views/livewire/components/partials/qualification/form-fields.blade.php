@if(! isset($meeting))
    ...
    @include('laravel-crm::partials.form.text',[
     'name' => 'univercity',
     'label' => ucfirst(__('laravel-crm::lang.univercity')),
     'attributes' => [
           'wire:model' => 'univercity',
      ]
    ])
    @include('laravel-crm::partials.form.text',[
     'name' => 'institute',
     'label' => ucfirst(__('laravel-crm::lang.institute')),
     'attributes' => [
    ...
    @include('laravel-crm::partials.form.text',[
     'name' => 'percentage',
     'label' => ucfirst(__('laravel-crm::lang.percentage')),
     'attributes' => [
